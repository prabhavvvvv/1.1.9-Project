...
def draw_iron_man(x, y):
    ...
    print(f"Thanos dropped his Infinity Stone! {new_color.upper()} has been added to the list. The current colors now are {head_colors}.")

    if len(head_colors) > 4:
        print("Infinity stones acquired")
    else:
